...
public:
	...
	void get_HTMLProject()
	{
		InvokeHelper(0x71f, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	...
	void get_Permission()
	{
		InvokeHelper(0x8d8, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	void get_SharedWorkspace()
	{
		InvokeHelper(0x8d9, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	void get_Sync()
	{
		InvokeHelper(0x8da, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	...
	void get_SmartDocument()
	{
		InvokeHelper(0x8e1, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	void get_DocumentLibraryVersions()
	{
		InvokeHelper(0x8e2, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	...
	void get_ContentTypeProperties()
	{
		InvokeHelper(0x9d0, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	...
	void get_Signatures()
	{
		InvokeHelper(0x9d4, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	...
	void get_ServerPolicy()
	{
		InvokeHelper(0x9d7, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	void LockServerFile()
	{
		InvokeHelper(0x9d8, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
	}
	void get_DocumentInspectors()
	{
		InvokeHelper(0x9d9, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	void GetWorkflowTasks()
	{
		InvokeHelper(0x9da, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
	}
	void GetWorkflowTemplates()
	{
		InvokeHelper(0x9db, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
	}
	...
	void get_CustomXMLParts()
	{
		InvokeHelper(0x9e2, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	BOOL get_Final()
	{
		BOOL result;
	...
	void get_Theme()
	{
		InvokeHelper(0x9e5, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
