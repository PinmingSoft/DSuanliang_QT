...
public:
	...
	void get_Scripts()
	{
		InvokeHelper(0x718, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	...
	void get_MailEnvelope()
	{
		InvokeHelper(0x7e5, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	...
	void ExportToPNG(VARIANT& FilePath)
	{
		static BYTE parms[] = VTS_VARIANT ;
		InvokeHelper(0x51200f, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &FilePath);
	}
