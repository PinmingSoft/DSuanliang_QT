...
//#import "D:\\Program Files (x86)\\WPS Office\\11.1.0.8976\\office6\\etapi.dll" no_namespace
// CApplication 包装类
...
public:
	...
	void get_Assistant()
	{
		InvokeHelper(0x59e, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	void Calculate()
	{
	...
	void get_CommandBars()
	{
		InvokeHelper(0x59f, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	...
	void get_FileSearch()
	{
		InvokeHelper(0x4b0, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	void get_FileFind()
	{
		InvokeHelper(0x4b1, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	void _FindFile()
	{
	...
	void get_COMAddIns()
	{
		InvokeHelper(0x704, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	...
	void get_LanguageSettings()
	{
		InvokeHelper(0x709, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	...
	void get_AnswerWizard()
	{
		InvokeHelper(0x70c, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	void CalculateFull()
	{
	...
	void get_FeatureInstall()
	{
		InvokeHelper(0x710, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	void put_FeatureInstall(BOOL  newValue)
	{
	...
	void get_AutomationSecurity()
	{
		InvokeHelper(0x795, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	void put_AutomationSecurity(BOOL newValue)
	{
		static BYTE parms[] = VTS_UNKNOWN ;
		InvokeHelper(0x795, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	void get_FileDialog(long fileDialogType)
	{
		static BYTE parms[] = VTS_UNKNOWN ;
		InvokeHelper(0x796, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, parms, fileDialogType);
	}
	void Dummy14()
	{
	...
	void get_NewWorkbook()
	{
		InvokeHelper(0x61d, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	...
	void get_Assistance()
	{
		InvokeHelper(0x952, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	...
	void get_SmartArtLayouts()
	{
		InvokeHelper(0xad4, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	void get_SmartArtQuickStyles()
	{
		InvokeHelper(0xad5, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	void get_SmartArtColors()
	{
		InvokeHelper(0xad6, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
	...
	void get_FileValidation()
	{
		InvokeHelper(0xae4, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
