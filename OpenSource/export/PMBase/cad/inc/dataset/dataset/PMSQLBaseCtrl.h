...
class DATASETDLLEXPORT CPMSQLBaseCtrl  
{
public:
	...
	class DATASETDLLEXPORT CSQLTransaction
	{
	public:
	...
	*/
	...
	static bool BuildSQL(CSQLType sqlType,CSQLDataSet * pDataSet,CString & sNewSQL);
	...
	*/
	...
	bool ExecuteSQL_FAST(LPCTSTR strSQL);
...
class DATASETDLLEXPORT CPMSQLTableCtrl
{
public:
