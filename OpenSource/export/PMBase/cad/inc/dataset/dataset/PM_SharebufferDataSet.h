...
时    间：[2010:10:4]   21:32
*********************************************************************/ 
class DATASETDLLEXPORT CPM_SharebufferDataSet : public CPM_StorageDataSet
{
public:
	...
	* @date  : [3/8/2012]
	*/
	BOOL CheckIsPrimaryDataSet(PMShared_Ptr<NDataModelDataSet> pCheckDataSet);
	...
	* @date  : [18/5/2012]
	*/
	CPM_SharebufferDataSet(PMShared_Ptr<NDataModelDataSet> pPrimaryDataSet);
	...
	* @date  : [18/5/2012]
	*/
	CPM_SharebufferDataSet(CUIntArray & iRowIDArr,PMShared_Ptr<NDataModelDataSet> pPrimaryDataSet);
...
protected:
	...
	//因为共享buffer,所以此处最好存储共享指针
	PMShared_Ptr<NDataModelDataSet> m_pPrimaryDataSet;
