...
class DATASETDLLEXPORT CPMArray  
{
public:
	...
	* @date  : [23/5/2012]
	*/
	inline const TNode & GetAt(INT_PTR nIndex) const
	{
...
* @date  : [15/1/2014]
*/
class DATASETDLLEXPORT CDataSetErrorInfo
{
public:
...
//DataSet的基类，定义了主要的借口
class DATASETDLLEXPORT NDataModelBase  :public CObject ,public CNotifyPtr
{
public:
	NDataModelBase();
