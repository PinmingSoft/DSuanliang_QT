...
*********************************************************************/ 
class DATASETDLLEXPORT CPM_LargeFileDataSet : public CPM_StorageDataSet
{
	DECLARE_DYNCREATE(CPM_LargeFileDataSet) 
public:

	struct DATASETDLLEXPORT CLargeFieldInfo
	{
	public:
	...
	class DATASETDLLEXPORT CStreamFileCtrl
	{
	public:
		CStreamFileCtrl();
	...
	class DATASETDLLEXPORT CFileRecordStreamCtrl
	{
	public:
