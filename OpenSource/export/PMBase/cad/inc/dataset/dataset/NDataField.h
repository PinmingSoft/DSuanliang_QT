...
* @date  : [15/1/2014]
*/
class DATASETDLLEXPORT NDataField : public CObject  
{
public:
...
// 							 CFont *font,Alignment alig,BOOL ADone);
	...
	*********************************************************************/ 
	...
	virtual  BOOL SetAsString(const void* val,void *buffer, int buffLen);
...
protected:
	...
	BOOL IsNotEqual(const void * pData1,const void * pData2);
	...
	BOOL IsIn(const void * pData1,const void * pData2);
