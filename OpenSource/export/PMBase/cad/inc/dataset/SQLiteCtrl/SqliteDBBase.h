...
// 简单封装的Sqlite数据库对象
class DATASETDLLEXPORT CSqliteDataBase
{
public:
...
// 简单封装的Sqlite语句对象
class DATASETDLLEXPORT CSqliteDBStmt
{
public:
	...
	*/
	int CopyTable(const CString& strSrcDbName,const CString& strSrcTableName,const CString& strDesDbName,const CString& strDesTableName);
	/**
	*  @brief : 获取数据库语句对象指针
	*
	*
