...
typedef DWORD PMTDWORD;
#else
typedef unsigned __int64  PMTDWORD;
#endif
...
public:
    ...
    BOOL Add(LPCTSTR sz, PMTDWORD dwData);
	...
	BOOL Lookup(LPCTSTR sz, PMTDWORD& dwData) const;
    ...
    void GetNextAssoc(HASH_POS& pos, LPCTSTR& sz, PMTDWORD& dwData) const;
