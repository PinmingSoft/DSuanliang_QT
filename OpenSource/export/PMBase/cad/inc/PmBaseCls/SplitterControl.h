...
class PMBASECLASSAPI CSplitterControl : public CStatic
{
// Construction
public:
	CSplitterControl();
...
public:
	//设置移动范围，该范围为在父对话框中Client坐标范围,不是GetWindowRect范围
	...
	* @date  : 2020/5/21
	*/	
	void SetIsDefault(BOOL bIsDe);

	BOOL GetIsDefault(){return m_bIsDeFault;};
