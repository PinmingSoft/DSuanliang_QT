...
#ifndef _PRJ_BASECLASS
PMBASECLASSAPI UINT WM_XLISTCTRL_COMBO_SELECTION;
PMBASECLASSAPI UINT WM_XLISTCTRL_EDIT_END;
PMBASECLASSAPI UINT WM_XLISTCTRL_CHECKBOX_CLICKED;
#endif 
...
class PMBASECLASSAPI CXListCtrl : public CListCtrl
{
// Construction
public:
	CXListCtrl();
...
public:
	...
	BOOL	GetItemColors(int nItem,								//+++
						  ...
						  COLORREF& crText, 
						  COLORREF& crBackground);
	DWORD	GetItemAttachData(int nItem);
	...
	void	SetItemColors(int nItem,								//+++
						  ...
						  COLORREF crText, 
						  COLORREF crBackground);
	BOOL	SetItemAttachData(int nItem, DWORD dwData);
