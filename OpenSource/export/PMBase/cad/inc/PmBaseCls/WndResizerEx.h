...
class PMBASECLASSAPI CWndResizerEx 
{
public:
	CWndResizerEx(void);
	~CWndResizerEx(void);
private:
	...
	{
	public:
		CSplitterGripperPanel(CWndResizerEx::SplitterOrientation type);
		~CSplitterGripperPanel();
		virtual void Draw(CDC * pDC);
		virtual CString GetTypeName();
	private:
		CWndResizerEx::SplitterOrientation m_OrienType;
	};
	...
	{
	public:
		CSpitterPanel(CWndResizerEx::SplitterOrientation type);
		CSpitterPanel(const CRect * prc, CWndResizerEx::SplitterOrientation type);
		~CSpitterPanel();
		virtual CString GetTypeName();
	...
	{
	public:
		CSplitContainer(CSplitPanel * pPanelA, CSplitPanel * pPanelB, CWndResizerEx::SplitterOrientation type);
		~CSplitContainer();
		virtual void OnResized();
		virtual BOOL AddChild(CPanel * prc);
		virtual BOOL RemoveChild(CPanel * prc);
		...
		static CWndResizerEx::CSplitContainer * Create(CPanel * pPanelA, CPanel * pPanelB);

		CWndResizerEx::SplitterOrientation m_Orientation;
	private:
	...
	public:
		...
		virtual void OnResized();
		virtual CString GetTypeName();
		void SetFlowDirection(CWndResizerEx::FlowDirection direction);
		CWndResizerEx::FlowDirection GetFlowDirection();
	...
	private:
		int m_nItemSpacingX;
		int m_nItemSpacingY;
		CWndResizerEx::FlowDirection m_nFlowDirection;
	};
...
private:
	...
	CWndResizerEx::CPanel * FindPanelByName(CWndResizerEx::CPanel * pRoot, LPCTSTR name);
	CWndResizerEx::CPanel * FindSplitterFromPoint(CWndResizerEx::CPanel * pRoot, CPoint point);
	void GetUIPanels(CWndResizerEx::CPanel * pRoot, CPanelList * pList, BOOL bOle);
	void GetVisualPanels(CWndResizerEx::CPanel * pRoot, CPanelList * pList);

	void ResizeUI(CWndResizerEx::CPanel * pRoot);

	CString IdToName(UINT uID);
	CWndResizerEx::CUIPanel * CreateUIPanel(UINT uID);
	CWndResizerEx::CUIPanel * GetUIPanel(UINT uID);
